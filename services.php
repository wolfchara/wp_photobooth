...
<div class="services__container">
    ...
    <div class="price__container__wrapper">
      <div class="first-price__container__wrapper-content price__container__wrapper-content">
        ...
        <p>
          ...
          adipisci sint enim, doloribus facere quis cum ad nulla eligendi
          nisi, neque labore nemo provident incidunt praesentium illo tempore,
          a soluta?
        </p>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut
        ...
        <a href="<?php echo get_page_link(36); ?>"><button class="price__button">Контакты</button></a>
      </div>
  ...
  <div class="additional">
    ...
    <div class="additional__container">
      <div class="additional__backdrop">
        <div class="additional__backdrop-image additional__image">
          <img src="http://photobooth/wp-content/themes/photobooth/assets/img/additional__backdrop-image.jpg" alt="backdrop-image" />
        </div>
      ...
      <div class="additional__custom-backdrop">
        <div class="additional__custom-backdrop-image additional__image">
          <img src="http://photobooth/wp-content/themes/photobooth/assets/img/additional__custom-backdrop-image.jpg" alt="custom-backdrop-image" />
        </div>
      ...
      <div class="additional__printing">
        <div class="additional__printing-image additional__image">
          <img src="http://photobooth/wp-content/themes/photobooth/assets/img/additional__printing-image.jpg" alt="printing-image" />
        </div>
      ...
      <div class="additional__stream">
        <div class="additional__stream-image additional__image">
          <img src="http://photobooth/wp-content/themes/photobooth/assets/img/additional__stream-image.jpg" alt="stream-image" />
        </div>
      ...
      <div class="additional__USB">
        <div class="additional__USB-image additional__image">
          <img src="http://photobooth/wp-content/themes/photobooth/assets/img/additional__USB-image.jpg" alt="USB-image" />
        </div>
    ...
    <h2 class="additional__title additional__title-down">
      ...
      потребностей, просто позвоните нам по адресу <a class="call-to-us" href="tel: +7(123)-456-7890">+7(123)&#8209;456&#8209;7890</a> за
  ...
  <div class="categories">
    <div class="category smooth">
      <img src="http://photobooth/wp-content/themes/photobooth/assets/img/category__wedding-image.jpg" alt="wedding">
      <div class="go-top">
        <h3>Свадьба</h3>
        <hr>
        <p>
    ...
    <div class="category smooth">
      <img src="http://photobooth/wp-content/themes/photobooth/assets/img/category__thanksgiving-image.jpg" alt="wedding">
      <div class="go-top">
    ...
    <div class="category smooth">
      <img src="http://photobooth/wp-content/themes/photobooth/assets/img/category__birthday-image.jpg" alt="wedding">
      <div class="go-top">
        <h3>День Рождения</h3>
        <hr>
        <p>
    ...
    <div class="category smooth">
      <img src="http://photobooth/wp-content/themes/photobooth/assets/img/category__events-image.jpg" alt="wedding">
      <div class="go-top">
    ...
    <div class="category smooth">
      <img src="http://photobooth/wp-content/themes/photobooth/assets/img/category__party-image.jpg" alt="wedding">
      <div class="go-top">
        <h3>Вечеринка</h3>
        <hr>
        <p>
  ...
  <div class="main-icons__container">
    <div class="first-icons__container icons__container">
      ...
      <div class="icon-container">
        <img src="http://photobooth/wp-content/themes/photobooth/assets/img/icons/gift-icon.png" alt="gift" />
    ...
    <div class="second-icons__container icons__container">
      <div class="icon-container">
        <img src="http://photobooth/wp-content/themes/photobooth/assets/img/icons/wheelchair.png" alt="wheelchair" />
      ...
      <div class="icon-container">
        <img src="http://photobooth/wp-content/themes/photobooth/assets/img/icons/like.png" alt="like" />
        <p>Нравится</p>
        <p>
